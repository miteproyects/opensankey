...

    {
        ...
        "substeps": [
            ...
            {"id": "1D", "name": "Future Options", "status": "future",
             ...
             "details": "Magic link login Â· Phone SMS OTP Â· Microsoft/Apple/GitHub SSO Â· MFA (TOTP) Â· Custom JWT claims Â· Session cookies"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "2C", "name": "Future Options", "status": "future",
             ...
             "details": "Supabase Â· SQLAlchemy ORM Â· Row-Level Security Â· Read replicas Â· Alembic migrations Â· Redis cache Â· Encrypted columns"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "3A", "name": "RBAC Module (rbac.py)", "status": "done",
             ...
             "details": "5 roles (ownerâviewer), granular permissions, guard functions, role hierarchy, display helpers"},

            {"id": "3B", "name": "Future Options", "status": "future",

             "details": "ABAC Â· Custom roles Â· Temporary access Â· Permission delegation Â· IP restrictions"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "4C", "name": "Future Options", "status": "future",
             ...
             "details": "Docker Â· Vercel/Fly.io/Render Â· GitHub Actions CI/CD Â· Staging env Â· Secrets Manager Â· Custom domain SSL"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "5B", "name": "Future Options", "status": "future",
             ...
             "details": "Middleware decorator Â· FastAPI backend Â· WebSocket session sync"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "6B", "name": "Pricing Tiers", "status": "deferred",
             ...
             "details": "Free (1 user) Â· Basic ($X/mo, 5 users) Â· Pro ($X/mo, 25 users) Â· Enterprise (unlimited)"},

            {"id": "6C", "name": "Implementation Files", "status": "deferred",

             "details": "billing.py Â· billing_page.py Â· webhooks.py Â· DB updates Â· RBAC plan gating"},

            {"id": "6D", "name": "Future Options", "status": "future",

             "details": "Stripe Elements Â· Metered billing Â· Annual discount Â· LATAM payments (Kushki) Â· Invoice billing Â· Free trial"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "7C", "name": "Future Options", "status": "future",
             ...
             "details": "Direct SRI API Â· OCR for scanned invoices Â· Bank statement import Â· ML auto-categorization Â· Real-time sync Â· Rules engine"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "8A", "name": "Enhanced Charts", "status": "partial",
             ...
             "details": "Sankey diagrams â Â· Stock charts â Â· Invoice volume (TODO) Â· Tax dashboard (TODO) Â· Supplier breakdown (TODO)"},

            {"id": "8B", "name": "Future Options", "status": "future",

             "details": "Embeddable dashboards Â· Scheduled email reports Â· Custom dashboard builder Â· AI insights (Claude API) Â· Export Â· Comparison mode"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "9B", "name": "ISO 27001 / SOC 2 Roadmap", "status": "pending",
             ...
             "details": "Security policy Â· Risk assessment Â· Access control docs Â· Incident response Â· BCP Â· Vendor assessment Â· Pen testing Â· Training"},

            {"id": "9C", "name": "Future Options", "status": "future",

             "details": "WAF Â· Rate limiting Â· CAPTCHA Â· Security headers Â· Vulnerability scanning Â· Data residency Â· Backup testing"},
...

    {
        ...
        "substeps": [
            ...
            {"id": "10C", "name": "Future Options", "status": "future",
             ...
             "details": "SSO/SAML enterprise Â· API keys Â· White-label branding Â· Multi-language (ES/EN) Â· Notification system"},
...
# ââ Security Issues Data ââââââââââââââââââââââââââââââââââââââââââââââââ
...
SECURITY_ISSUES = [
...

    {
        ...
        "description": "When a user's role changes (e.g., viewer â admin), the session token is not regenerated, creating a session fixation risk.",
...
# ââ Compliance Data âââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
def _status_badge(status: str) -> str:
    ...
    _tips = {
        ...
        "done": "This task is fully completed and verified.",

        "partial": "Work is actively underway on this task.",

        "pending": "This task has not been started yet.",

        "deferred": "This task is postponed to a future phase.",
    ...
    m = {
        ...
        "done":     ("â Done",       "#10B981", "#ECFDF5"),

        "partial":  ("ð§ In Progress","#F59E0B", "#FFFBEB"),

        "pending":  ("â³ Pending",    "#6B7280", "#F3F4F6"),

        "deferred": ("â¸ï¸ Deferred",   "#6366F1", "#EEF2FF"),

        "future":   ("ð® Future",     "#A855F7", "#FAF5FF"),

        "open":     ("ð´ Open",       "#EF4444", "#FEF2F2"),

        "mitigated":("ð¡ Mitigated",  "#F59E0B", "#FFFBEB"),

        "resolved": ("ð¢ Resolved",   "#10B981", "#ECFDF5"),
...
def _severity_badge(severity: str) -> str:
    ...
    _tips = {
        ...
        "critical": "Requires immediate action. System is at serious risk.",

        "high": "Should be addressed urgently. Significant impact possible.",

        "medium": "Should be planned for remediation soon.",
...
.info-tip .tip-text {
  ...
  padding: 10px 14px; border-radius: 8px; font-size: 0.78rem; font-weight: 400; line-height: 1.5;

  white-space: normal; width: max-content; max-width: 300px; z-index: 9999;
...
def _render_dashboard():
    ...
    <div class="nsfe-header">
        ...
        <h1>QuarterCharts â Phase 2 Dashboard</h1>

        <p>Full implementation roadmap &nbsp;Â·&nbsp; 10 Steps &nbsp;Â·&nbsp; {overall_pct}% overall progress</p>

        <div style="max-width:400px;margin:16px auto 0;">

            {_progress_bar(overall_pct, '#3B82F6', 'Overall completion across all 10 steps.')}

        </div>

        <div class="metrics-row">

            {_metric_card(done_count, "Completed", "#10B981", "Number of steps fully finished and verified.")}

            {_metric_card(partial_count, "In Progress", "#F59E0B", "Steps currently being worked on.")}

            {_metric_card(pending_count, "Pending", "#6B7280", "Steps that have not been started yet.")}

            {_metric_card(deferred_count, "Deferred", "#6366F1", "Steps postponed to a future phase.")}
    ...
    for step in STEPS:
        ...
        bar = _progress_bar(step["progress"], step["color"], f'Step {step["num"]} is {step["progress"]}% complete.')
            ...
            for sub in step["substeps"]:
                ...
                <div class="substep">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;">
                        ...
                        <span class="substep-name">{sub['id']}. {sub['name']}{_info_tip(sub.get('details','Subtask detail'))}</span>

                        {sub_badge}

                    </div>

                    <div class="substep-detail">{sub['details']}{_info_tip("Detailed description of what this subtask involves.")}</div>
    ...
    impl = [
        ...
        (True,  "auth.py â Firebase Auth backend"),

        (True,  "database.py â PostgreSQL database layer"),

        (True,  "rbac.py â Role-based access control"),

        (True,  "login_page.py â Auth UI"),

        (True,  "requirements.txt â Updated dependencies"),

        (True,  "SETUP_AUTH.md â Setup documentation"),

        (False, "Integrate auth into app.py â Wire everything together"),

        (False, "Firebase project creation â Set up actual Firebase project"),

        (False, "Railway PostgreSQL â Create and connect database"),

        (False, "Test end-to-end auth flow â Login, signup, Google SSO, session timeout"),

        (False, "Data upload pipeline â SRI invoice parser and storage"),

        (False, "Enhanced dashboards â Financial visualizations from uploaded data"),

        (False, "Team management UI â Invite members, assign roles"),

        (False, "Stripe billing â Payment integration"),

        (False, "Security hardening â Rate limiting, CAPTCHA, security headers"),

        (False, "ISO 27001 preparation â Documentation, policies, audit readiness"),
    ...
    st.markdown(
        ...
        f'<div class="impl-order"><h3>ð Implementation Order</h3>{items_html}</div>',
...
def _render_security():
    ...
    <div class="nsfe-header">
        ...
        <p>Vulnerability tracking &nbsp;Â·&nbsp; ISO 27001 readiness &nbsp;Â·&nbsp; {total} issues tracked</p>

        <div class="metrics-row">

            {_metric_card(critical, "Critical", "#DC2626", "Issues that need immediate attention.")}

            {_metric_card(high, "High", "#EA580C", "High-priority issues to address urgently.")}

            {_metric_card(medium, "Medium", "#D97706", "Medium-priority issues to plan for.")}

            {_metric_card(low_info, "Low / Info", "#2563EB", "Low severity or informational findings.")}

            {_metric_card(open_count, "Open", "#EF4444", "Unresolved issues requiring action.")}

            {_metric_card(mitigated, "Mitigated", "#F59E0B", "Issues with temporary workarounds in place.")}

            {_metric_card(resolved, "Resolved", "#10B981", "Issues fully fixed and verified.")}
    ...
    for issue in filtered:
        ...
        <div class="sec-card">
            ...
            <div class="sec-card-header">
                ...
                <span class="sec-card-id">{issue['id']}{_info_tip("Unique security issue identifier.")}</span>

                {sev}

                <span class="sec-card-title">{issue['title']}{_info_tip(issue['description'])}</span>

                {stat}

            </div>

            <span class="sec-card-cat">{issue['category']}{_info_tip("ISO 27001 security category.")}</span>

            <span style="font-size:0.75rem;color:#475569;margin-left:12px;">Found: {issue['date_found']}</span>

            <span style="font-size:0.75rem;color:#475569;margin-left:12px;">Affected: {issue['affected']}{_info_tip("System components impacted by this issue.")}</span>

            <div class="sec-card-body">{issue['description']}</div>

            <div class="sec-card-rec">ð¡ <strong>Recommendation:</strong>{_info_tip("Suggested action to resolve this issue.")} {issue['recommendation']}</div>
    ...
    st.markdown("### ðï¸ ISO 27001 Control Status")
...
def _render_settings():
    ...
    <div class="nsfe-header">
        ...
        <p>System configuration &nbsp;Â·&nbsp; Quick actions</p>
    ...
    st.markdown("### ð Quick Links" + _info_tip("Direct links to your key service dashboards."), unsafe_allow_html=True)
    ...
    st.markdown("### ð¦ Repository" + _info_tip("Source code and live deployment links."), unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("### 🚀 Environment & Deployment (Step 4)" + _info_tip("Environment variable status and deployment configuration."), unsafe_allow_html=True)

    # ── Env var status checks ──
    env_vars = {
        "FIREBASE_CREDENTIALS": {
            "value": os.environ.get("FIREBASE_CREDENTIALS", ""),
            "required": True,
            "description": "Firebase service account JSON (base64-encoded or raw JSON)",
            "setup": "Railway Dashboard → Variables → Add FIREBASE_CREDENTIALS with your Firebase service account key JSON",
        },
        "FIREBASE_CONFIG": {
            "value": os.environ.get("FIREBASE_CONFIG", ""),
            "required": True,
            "description": "Firebase web config JSON (apiKey, authDomain, projectId, etc.)",
            "setup": "Firebase Console → Project Settings → Web app → Copy config → Paste as JSON in Railway Variables",
        },
        "DATABASE_URL": {
            "value": os.environ.get("DATABASE_URL", ""),
            "required": True,
            "description": "PostgreSQL connection string (auto-linked by Railway if DB is in same project)",
            "setup": "Railway Dashboard → PostgreSQL service → Variables tab → Copy DATABASE_URL",
        },
        "ANTHROPIC_API_KEY": {
            "value": os.environ.get("ANTHROPIC_API_KEY", ""),
            "required": False,
            "description": "API key for the AI Assistant tab (Claude)",
            "setup": "console.anthropic.com → API Keys → Create key → Add to Railway Variables",
        },
        "STRIPE_SECRET_KEY": {
            "value": os.environ.get("STRIPE_SECRET_KEY", ""),
            "required": False,
            "description": "Stripe secret key for billing (Step 6)",
            "setup": "Stripe Dashboard → Developers → API Keys → Copy sk_live_... → Add to Railway Variables",
        },
        "STRIPE_WEBHOOK_SECRET": {
            "value": os.environ.get("STRIPE_WEBHOOK_SECRET", ""),
            "required": False,
            "description": "Stripe webhook signing secret",
            "setup": "Stripe Dashboard → Webhooks → Add endpoint → Copy signing secret → Add to Railway Variables",
        },
    }

    configured = sum(1 for v in env_vars.values() if v["value"])
    required_configured = sum(1 for v in env_vars.values() if v["required"] and v["value"])
    required_total = sum(1 for v in env_vars.values() if v["required"])

    st.markdown(f"""
    <div class="step-card">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
            <div style="font-size:1.1rem;font-weight:700;color:#F1F5F9;">Environment Variables</div>
            <div style="font-size:0.85rem;color:#94A3B8;">{configured}/{len(env_vars)} configured &nbsp;&middot;&nbsp; {required_configured}/{required_total} required</div>
        </div>
        {_progress_bar(int(configured / len(env_vars) * 100), '#3B82F6' if configured == len(env_vars) else '#F59E0B')}
    </div>
    """, unsafe_allow_html=True)

    for name, info in env_vars.items():
        is_set = bool(info["value"])
        icon = "✅" if is_set else ("🔴" if info["required"] else "⚪")
        status_text = "Configured" if is_set else ("Missing — Required" if info["required"] else "Not set — Optional")
        status_color = "#10B981" if is_set else ("#EF4444" if info["required"] else "#64748B")
        masked = ""
        if is_set:
            val = info["value"]
            if len(val) > 12:
                masked = val[:4] + "•" * 8 + val[-4:]
            else:
                masked = "•" * len(val)

        st.markdown(f"""
        <div class="step-card" style="padding:16px 20px;margin-bottom:8px;">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
                <span style="font-size:1.1rem;">{icon}</span>
                <code style="font-weight:700;color:#F1F5F9;font-size:0.9rem;background:#1E293B;padding:2px 8px;border-radius:4px;">{name}</code>
                <span style="font-size:0.78rem;color:{status_color};font-weight:600;">{status_text}</span>
                {"<span style='font-size:0.7rem;color:#F59E0B;background:#F59E0B22;padding:1px 6px;border-radius:4px;'>REQUIRED</span>" if info["required"] else ""}
            </div>
            <div style="font-size:0.82rem;color:#94A3B8;margin-left:30px;">{info["description"]}</div>
            {"<div style='font-size:0.78rem;color:#64748B;margin-left:30px;font-family:monospace;margin-top:2px;'>Value: " + masked + "</div>" if masked else ""}
        </div>
        """, unsafe_allow_html=True)

        if not is_set:
            with st.expander(f"📋 Setup instructions for {name}", expanded=False):
                st.markdown(f"""
                <div class="sec-card-rec">{info["setup"]}</div>
                """, unsafe_allow_html=True)

    st.markdown("---")

    st.markdown("### â¡ System Info" + _info_tip("Current system status and configuration."), unsafe_allow_html=True)
    ...
    <div class="step-card">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
            ...
            <div><span style="color:#64748B;font-size:0.85rem;">Auto-deploy:</span> <span style="color:#10B981;">GitHub main â Railway</span></div>
...
_CHAT_SYSTEM_PROMPT = """You are the QuarterCharts AI Assistant â a helpful expert embedded in the NSFE Manager Control Center.
...
You are part of QuarterCharts â a financial visualization platform targeting $50K/year B2B SaaS.
...
def _render_chat():
    ...
    <div class="nsfe-header">
        ...
        <p>Claude-powered assistant &nbsp;Â·&nbsp; Ask anything about QuarterCharts</p>
    ...
    if not api_key:
        ...
        st.warning("â ï¸ **Anthropic API key not configured.**")
        ...
        <div class="step-card">
            ...
            <div style="color:#94A3B8;font-size:0.9rem;line-height:1.7;">
                ...
                1. Go to <strong>console.anthropic.com</strong> â API Keys<br>

                2. Create a new key<br>

                3. In Railway dashboard â Variables, add:<br>

                <code style="background:#1E293B;padding:4px 8px;border-radius:4px;color:#10B981;">ANTHROPIC_API_KEY=sk-ant-...</code><br>

                4. Redeploy â the chat will activate automatically
        ...
        st.markdown("#### ð¬ Preview Mode (no API key)" + _info_tip("Limited mode without API. Messages are saved but not processed by AI."), unsafe_allow_html=True)
    ...
    for msg in st.session_state.nsfe_chat_history:
        ...
        with st.chat_message(msg["role"], avatar="ð§âð¼" if msg["role"] == "user" else "ð¤"):
        ...
        with st.chat_message("assistant", avatar="ð¤"):
            ...
            if api_key:
                ...
                try:
                    ...
                    err = "â `anthropic` package not installed. Add `anthropic` to requirements.txt and redeploy."
                ...
                placeholder_msg = ("ð¡ **API key not configured yet.** Your message has been saved. "
    ...
    st.markdown("#### â¡ Quick Prompts" + _info_tip("Click any prompt to quickly start a conversation."), unsafe_allow_html=True)
    ...
    if st.button("ðï¸ Clear Chat History", type="secondary"):
...
def render_nsfe_page():
    ...
    if not st.session_state.get("nsfe_auth", False):
        ...
        <div class="lock-container">
            ...
            <div class="lock-title">NSFE â Restricted Area</div>

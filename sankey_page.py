...
def render_sankey_page():
    ...
    if sankey_view == "income":
        ...
        if sel:
            ...
            _income_popup()
        st.markdown(f'<div style="text-align:center;color:#888;font-size:0.85rem;margin-top:0.75rem;margin-bottom:0.5rem">{_compare_note + " &middot; " if _compare_note else ""}Annual financial flow visualization</div>', unsafe_allow_html=True)
